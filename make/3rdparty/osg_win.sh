...
# A zip file is provided here https://wiki.openpilot.org/download/attachments/5472258/MSYS-1.0.11.zip
...
#
# Sample command line to exzcute this script from a MS shell :
#     .\tools\msys\bin\sh --login -i -c /d/Projects/OpenPilot/make/3rdparty/osg_win.sh
#
...
#MINGW_DIR=D:/Projects/OpenPilotTools/qt-5.4.0/Tools/mingw491_32
#MINGW_DIR=C:/Apps/tools/qt-5.4.0/Tools/mingw491_32
if [ -z "$MINGW_DIR" ]; then
...
patch < $WORK_DIR/gdal_GNUmakefile_fix.diff
