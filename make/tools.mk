...
ifeq ($(UNAME), Linux)
    ifeq ($(ARCH), x86_64)
        ...
        OSG_SDK_DIR := $(TOOLS_DIR)/osg-3.2.1-linux-x86-qt-5.4.1
    endif
else ifeq ($(UNAME), Darwin)
    OSG_SDK_DIR := $(TOOLS_DIR)/osg-3.2.1-clang_64-qt-5.4.1
else ifeq ($(UNAME), Windows)
    ...
    OSG_SDK_DIR  := $(BUILD_DIR)/3rdparty/install/osg-3.2.1-mingw491_32-qt-5.4.1
endif
